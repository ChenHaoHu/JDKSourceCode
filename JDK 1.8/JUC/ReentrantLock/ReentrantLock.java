 ...
 * <em>fairness （公平） </em> parameter.  When set {@code true}, under
 ...
 * methods for inspecting （检查） the state of the lock.  Some of these
...
public class ReentrantLock implements Lock, java.io.Serializable {
    ...
    private final Sync sync; //公平锁 与 非公平
    ...
    /**
     * Sync object for non-fair locks  //非公平锁  默认
     * 
     * 
     */
